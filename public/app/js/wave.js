...
uki({ view: 'HSplitPane', id: 'splitMain', rect: '15 15 975 950', minSize: '800 400', anchors: 'left top right bottom', handleWidth: 15, handlePosition: 166, leftMin: 166, rightMin: 600,
    ...
    rightChildViews: { view: 'HSplitPane', id: 'splitRight', rect: '795 950', anchors: 'left top right bottom', handleWidth: 15, handlePosition: 300, leftMin: 300, rightMin: 300,
        leftChildViews: { view: 'VSplitPane', id: 'splitLeft', rect: '166 950', anchors: 'left top right bottom', handleWidth: 16, handlePosition: 200, bottomMin: 230, topMin: 120,
            topChildViews: panel('Communities', { rect: '300 130', background: 'theme(panel-white)', childViews: [
                ...
                { view: 'ScrollPane', rect: '0 79 300 120', anchors: 'left top right bottom', childViews: [
                    { view: 'List', id: "communities", rect: '300 791', anchors: 'left top right bottom', background: 'none', textSelectable: false, rowHeight: 38, render: CommunitiesRender }
                ] },
                { view: 'Box', rect: '0 1000 300 16', background: 'theme(box-lblue-bottom)', anchors: 'left bottom right', childViews: [] }
            ] } ),
            bottomChildViews: panel('Discussions', { rect: '300 930', childViews: [
                ...
                { view: 'ScrollPane', rect: '0 103 300 791', anchors: 'left top right bottom', childViews: [
                    { view: 'List', id: "discussions", rect: '300 791', anchors: 'left top right bottom', background: 'none', textSelectable: false, rowHeight: 38, render: DiscussionsRender }
                ] },
        ...
        rightChildViews: panel('Posts', { rect: '470 930', background: 'theme(panel-blue)', childViews: [
            ...
            { view: 'Label', id: 'entries', rect: '0 97 470 774', anchors: 'left top right bottom', multiline: true, scrollable: true, inset: '2 2', textSelectable: true },
            { view: 'Box', rect: '0 870 470 56', background: 'theme(box-lblue)', anchors: 'left bottom right', childViews: [
