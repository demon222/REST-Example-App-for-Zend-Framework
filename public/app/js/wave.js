...
var DiscussionRender = {
    template: uki.theme.template('discussion-render'),
    render: function(data, rect, i) {
        return uki.extend(this.template, [
            undefined, uki.theme.imageSrc('unknown'),
            undefined, data.RecentEntry_Creator_username,
...
uki({ view: 'HSplitPane', id: 'splitMain', rect: '15 50 975 950', minSize: '800 400', anchors: 'left top right bottom', handleWidth: 15, handlePosition: 166, leftMin: 166, rightMin: 600,
    ...
    rightChildViews: { view: 'HSplitPane', id: 'splitRight', rect: '795 950', anchors: 'left top right bottom', handleWidth: 15, handlePosition: 300, leftMin: 300, rightMin: 300,
        leftChildViews: panel('Discussions', { rect: '300 930', childViews: [
            ...
            { view: 'ScrollPane', rect: '0 103 300 791', anchors: 'left top right bottom', childViews: [
                { view: 'List', id: "discussions", rect: '300 791', anchors: 'left top right bottom', background: 'none', textSelectable: false, rowHeight: 38, render: DiscussionRender }
            ] },
        ...
        rightChildViews: panel('Simplicity is the key', { rect: '470 930', background: 'theme(panel-blue)', childViews: [
            ...
            { view: 'Label', id: 'entries', rect: '0 103 470 791', anchors: 'left top right bottom', multiline: true, scrollable: true, inset: '2 2', textSelectable: true },
